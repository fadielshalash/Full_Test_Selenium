...
class SearchCustomer():
    ...
    tblSearchResults_xpath="/html/body/div[3]/div[1]/form[1]/section/div/div/div/div[2]/div"
    ...
    def getNoOfRows(self):
        tbody = self.driver.find_element(By.XPATH,self.tableRows_xpath)
        return (len(tbody.find_elements(By.XPATH,'./*')))



    def getNoOfColumns(self):
        tbody = self.driver.find_element(By.XPATH, self.tableColumns_xpath)
        return (len(tbody.find_elements(By.XPATH,'./*')))
